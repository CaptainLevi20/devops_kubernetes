...
// NOTE: todos are now served by a separate backend service.
// The frontend will call `/api/todos` which this server proxies
// to the backend defined by BACKEND_URL (env var).
